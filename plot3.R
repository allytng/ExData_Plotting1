# Reconstruct plot 3 to examine how household energy usage varies over a 2-day period in February, 2007 (2007-02-01 and 2007-02-02).
...
## Construct plot 3 and save in png file with width of 480 pixels and height of 480 pixels. 

png(filename = "plot3.png", width = 480, height = 480)

plot(data$Time, data$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "") ### plot sub_metering_1 line
points(data$Time, data$Sub_metering_2, type = "l", col = "red") ### add sub_metering_2 line
points(data$Time, data$Sub_metering_3, type = "l", col = "blue") ### add sub_metering_3 line
